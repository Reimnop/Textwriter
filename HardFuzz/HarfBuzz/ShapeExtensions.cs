...
namespace HardFuzz.HarfBuzz
{
    ...
    public static class ShapeExtensions
    {
        ...
        ///     shaping.
        /// </summary>
        public static void Shape(this Buffer buffer, Font font, params Feature[] features)
        {
        ...
        public static void Shape(this Buffer buffer, Font font, IEnumerable<string> shapers,
